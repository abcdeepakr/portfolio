export function Profiles(props) {
  switch(props.profileName){
    ...
    case "pexels.txt":
      // window.open("https://www.pexels.com/@eggroll/", '_blank');
      return (<p style={{"fontSize": "1rem"}}><a style={{"color": "aqua"}} href="https://www.pexels.com/@eggroll/" target="_blank" rel="noreferrer">Click here to open Pexels profile</a><br></br></p>)
    default:
