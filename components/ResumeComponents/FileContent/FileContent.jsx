    ...
    return (
      <div>
        <ul className={styles.list}>
          ...
          <li title="ctrl+click to open link in new tab"><a target="_blank" rel="noreferrer" className={styles.link} href="https://github.com/abcdeepakr">Build Stuff</a></li>
        </ul>
      </div>
    )
  }
      ...
      <div className={styles.skillsContainer}>
        <table >
          ...
          <tr className={styles.skillCol}>
            ...
            <td className={styles.skillDesc}>Used python to make CLI apps, to improve my problem solving skills and make <a target="_blank" rel="noreferrer" className={styles.link} href="https://github.com/abcdeepakr/projects">fun projects</a> like movie guessing game and a voice calculator. </td>
          </tr>
          <tr className={styles.skillCol}>
          ...
          <tr className={styles.skillCol}>
            ...
            <td className={styles.skillDesc}>Created small <a target="_blank" rel="noreferrer" className={styles.link} href="https://github.com/abcdeepakr?tab=repositories&q=&type=&language=golang&sort=">backend services </a>which serve data using REST APIs</td>
          </tr>
        </table>
      </div>
    )
