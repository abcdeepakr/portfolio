        ...
        <div className={styles.backdrop}>
            <div className={styles.profileCard}>
                <div className ={styles.profileImage}>
                    ...
                    <h6 ><Link href="https://www.google.com/search?client=firefox-b-d&q=deepakr28" target="_blank" className={styles.username}>@deepak.r28 </Link> | <LocationOnIcon color="error" /> Delhi</h6>
                </div>
